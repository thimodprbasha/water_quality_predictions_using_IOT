    ...
    <View style={{ flex: 1, padding: 0, backgroundColor:"white"}}>
      {/* {isLoading ? <Text>Loading...</Text> :           */}
        ...
        <LinearGradient
            ...
            <Text style = {styles.InnerHeadText}>Jane Cooper</Text>
                  ...
                  <View style = {styles.TestnBox1}> 
                    ...
                    <View style = {styles.OptionBoxInner}> 
                        <View style = {styles.TestInnerContent}>
                            <Text style ={styles.TestInnerContentTxt}>Excellent<br/><Text style = {{color:"#626263"}}>34</Text></Text>
                        </View>              
                        <View style = {styles.TestInnerContent}>
                            <Text style ={styles.TestInnerContentTxt}><Text style = {{color:"#0099C9"}}>Normal</Text><br/><Text style = {{color:"#626263"}}>34</Text></Text>
                        </View>              
                        <View style = {styles.TestInnerContent}>
                            <Text style ={styles.TestInnerContentTxt}><Text style = {{color:"#FF7B8A"}}>Bad</Text><br/><Text style = {{color:"#626263"}}>34</Text></Text>
                        </View>              
                    </View>
