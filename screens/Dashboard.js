...
export default function Dashboard({ navigation }) {
  ...
  // const [usr, getUserDetails] = useState("");
  ...
  useEffect(() => {
    ...
    var prevMonth = monthNames[currentPrevMonth]; //Current Month
        ...
        <View style={styles.StatusContainer}>
          ...
          >
            <View style={styles.OptionContainer}>
              ...
              <TouchableOpacity
                onPress={() => navigation.navigate("TestedAreas")}
              >
                <View style={styles.OptionBox1}>
                  <Image
            ...
            <TouchableOpacity
              ...
              onPress={() => handleItemClick(currentPrevDay+currentPrevMonth)}
            >
              <LinearGradient
                // Button Linear Gradient
